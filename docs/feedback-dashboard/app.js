...
const FALLBACK = [
  ...
  {name:"Sabrina Wong",from:"Rachel Jones",rel:"stakeholder",level:"Senior - non Tech",skills:{"Business Acumen":5,"Execute with Rigor":6,"Velocity":6,"Change Management":5,"Problem Solving":5},values:["Customer obsession","Integrity without compromise","Stronger together"],bestWork:"I haven't worked with Sabrina for long, but she's already made a fantastic impact. It is such a win to have her support! I'm particularly excited for next season \u2014 her natural sense of organization is exactly what we need to level up. The intern matching deck she created was not only functional but incredibly well-designed.",advice:"As we start revving up for the Summer '27 recruitment season, I'd love to see her partner more closely with Bryoni to explore where we can align our fintech internship processes. One area where Sabrina can make a massive impact is in manager alignment \u2014 ensuring everyone is on the same page this year.",other:""},
  {name:"Sabrina Wong",from:"Yukti",rel:"peer",level:"Senior - non Tech",skills:{"Business Acumen":9,"Execute with Rigor":10,"Velocity":9,"Change Management":10,"Problem Solving":9},values:["Courage","Customer obsession","Stronger together"],bestWork:"Sabrina recently joined the team and is ramping up really quickly. She's been picking things up fast, and is a very supportive teammate. It's been great to see her progress so far, and I'm looking forward to working with her more.",advice:"As she continues settling in, I think gaining more context around team and cross-functional priorities could help further increase her impact and visibility.",other:""},
  {name:"Sabrina Wong",from:"Vanessa Dunn",rel:"stakeholder",level:"Senior - non Tech",skills:{"Business Acumen":5,"Execute with Rigor":5,"Velocity":5,"Change Management":5,"Problem Solving":5},values:["Stronger together"],bestWork:"As Sabrina is new to the team, I'm excited to see what she contributes in the future.",advice:"Sabrina and I had a 1:1 brainstorm session (3/31) on how to improve the Risk Org. The first project we aligned on is setting up a video montage of success slides for the Risk MTV-20-03 Risk Area. For higher impact, it would be great to provide status updates without prompting.",other:"Cool feedback form :)"},
  {name:"Tyler Cialek",from:"Xueying Wang",rel:"peer",level:"Senior Staff",skills:{"Technical Craft":10,"Execution":10,"Customer Centric Outcomes":10,"Accelerating Teams":10,"Driving AI Adoption":10},values:["Courage","Customer obsession","Stronger together"],bestWork:"Tyler played a key leadership role in driving AI adoption for the FinTech Risk team. He organized trainings and office hours that made new capabilities more accessible, and most importantly, he consistently gathered feedback from both the team and our stakeholders. His efforts significantly accelerated adoption and enabled the team to move faster with greater confidence.",advice:"As Tyler continues to grow, expanding his influence across teams and driving even more cross-functional collaboration could further amplify his impact.",other:"Look forward to more opportunities to collaborate with Tyler in the near future."},
];
